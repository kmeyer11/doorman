...
def build_parser() -> argparse.ArgumentParser:
    ...
    scan.add_argument("--judge", choices=["anthropic", "openai"], default=None, help="Enable an LLM judge")
    ...
    benchmark.add_argument("--judge", choices=["anthropic", "openai"], default="anthropic")
    ...
    chat.add_argument("--target-provider", default="anthropic", choices=["anthropic", "openai"])
    chat.add_argument("--target-model", default=None)
    chat.add_argument("--judge-provider", default="anthropic", choices=["anthropic", "openai", "none"])
